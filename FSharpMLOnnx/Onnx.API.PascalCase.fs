...
type Onnx() =
    ...
    static member EyeLike<'a>(input: Tensor<int>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<int>, ?k: int64) =
        execNodeCheck<int> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<uint32>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<uint32>, ?k: int64) =
        execNodeCheck<uint32> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<int8>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<int8>, ?k: int64) =
        execNodeCheck<int8> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<uint64>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<uint64>, ?k: int64) =
        execNodeCheck<uint64> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<uint8>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<uint8>, ?k: int64) =
        execNodeCheck<uint8> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<int16>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<int16>, ?k: int64) =
        execNodeCheck<int16> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<int64>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<int64>, ?k: int64) =
        execNodeCheck<int64> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<double>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<double>, ?k: int64) =
        execNodeCheck<double> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<bool>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<bool>, ?k: int64) =
        execNodeCheck<bool> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<float32>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<float32>, ?k: int64) =
        execNodeCheck<float32> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike<'a>(input: Tensor<uint16>, ?k: int64) =
        execNodeCheck<'a> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    static member EyeLike(input: Tensor<uint16>, ?k: int64) =
        execNodeCheck<uint16> "EyeLike" [|MV.mv(1,input)|] [|6L; 12L; 3L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] ([|Attr.int("k", k, 0L)|] |> Array.choose id)
    ...
    static member Cast<'a>(input: Tensor<int>) =
        execNodeCheck<'a> "Cast" [|MV.mv(1,input)|] [|6L; 8L; 3L; 12L; 13L; 2L; 5L; 7L; 11L; 9L; 1L; 4L|] [||]
